...
%>
<div class="container">
    <h3>Xóa sinh viên: <%=sinhVien.getHoTen() %></h3>
    <br>
    ...
    <form action="XoaSinhVienServlet" method="post">
        ...
        <div class="row form-group">
            ...
            <div class="col-lg-3">
                <input type="text" class="form-control" name="hoten" readonly="readonly" value="<%=sinhVien.getHoTen()%>"/>
            </div>
        </div>
        <div class="row form-group">
            <label class="col-lg-2">Giới tính</label>
            <div class="col-lg-3">
                <input type="radio" name="gioitinh" value="1" style="margin-right: 10px;" readonly="readonly" >Nam
                <input type="radio" style="margin: 0px 10px 0px 30px;" name="gioitinh" value="0" readonly="readonly" >Nữ
            </div>
        </div>
        <div class="row form-group">
            <label class="col-lg-2">Khoa</label>
            <div class="col-lg-3">
                <select class="form-control" name="khoa" readonly="readonly">
                    <%
